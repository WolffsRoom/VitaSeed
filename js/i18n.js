const translations = {
    "pt-BR": {
        ...
        "btn_request": "Request",
        "btn_login": "Login",
        "about_title": "Sobre o VitARCH",
        "about_desc": "O VitARCH (Vita + Archive) é o novo repositório agregador para a cena homebrew do PSVita. Centralizamos Ports, Mods, Traduções, Plugins, Apps e Ferramentas.",
    ...
    "en": {
        ...
        "btn_request": "Request",
        "btn_login": "Login",
        "about_title": "About VitARCH",
        "about_desc": "VitARCH is a centralized aggregator for the PSVita homebrew scene. We index Ports, Mods, Translations, Plugins, Apps, and Tools to guarantee easy access for everyone.",
